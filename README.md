...
* CSG2A (Bang et al., 2024): [https://github.com/eugenebang/CSG2A](https://github.com/eugenebang/CSG2A)
  Embeddings were obtained from *Step 1: Pretraining of condition-specific response on the LINCS L1000 dataset*.

* Geneformer (Theodoris et al., 2023): [https://github.com/jkobject/geneformer](https://github.com/jkobject/geneformer)
  Embeddings were derived from the *Genecorpus-30M* pretraining.
